...
public class RestaurantCashierGui extends RestaurantParticipantGui {

	
	private Image imageSelf;	
	
	public RestaurantCashierGui(RestaurantParticipantPuppet p, GridCell startLoc) {
		super(p, startLoc);
		imageSelf = (new ImageIcon("img/dollar.png").getImage());
	}
